...
import data_io.minio.credentials.Credentials;
import data_io.minio.credentials.Provider;
import data_io.minio.credentials.StaticProvider;
import data_io.minio.errors.*;
import data_io.minio.http.HttpUtils;
import data_io.minio.http.Method;
import data_io.minio.messages.*;
...
public class MinioAsyncClient extends S3Base {
  ...
  public static final class Builder {
    ...
    public Builder credentials(String accessKey, String secretKey, String sessionToken) {
      this.provider = new StaticProvider(accessKey, secretKey, sessionToken);
      return this;
    }
